...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_Bookings_ToTable_Clients]...';


GO
ALTER TABLE [dbo].[Bookings] DROP CONSTRAINT [FK_Bookings_ToTable_Clients];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_Bookings_ToTable_Ports]...';


GO
ALTER TABLE [dbo].[Bookings] DROP CONSTRAINT [FK_Bookings_ToTable_Ports];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Bookings] ([Id], [clientId], [planet], [stopover], [planet_portId], [dateA], [dateB])
        SELECT   [Id],
                 [clientId],
                 [planet],
                 [stopover],
